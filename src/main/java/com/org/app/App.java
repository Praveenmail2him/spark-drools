...
public class App {
  public static void main(String[] args) {
    ...
    System.setProperty("hadoop.home.dir", "C:\\winutil\\winutils.exe");
    ...
    //Spark used to parallelize the input data and fire the rules for the rule which is in com/org/approval.drl
    ...
    applicants.saveAsTextFile("com.org.app"); // 2nd Action is Performed on this Job to Save the File.
    sc.close();
  }
